/*
* Computes the flux values to help render shadows for shadows created from light source 0. Shadows are rendered in a similar was to flux with the exception
